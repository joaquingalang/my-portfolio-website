...
function AwardCard({ imagePath, date, position, title, desc, orgImagePath, organizers, role }: Props) {
    return (
        <div className="flex flex-col gap-2">
            <img src={imagePath} className="h-[15rem] md:h-[20rem] lg:h-[15rem] min-w-full rounded-xl object-cover mb-2"/>
            ...
            <p className="font-poppins text-light/50 text-xs md:text-sm max-w-[50rem]">{desc}</p>
